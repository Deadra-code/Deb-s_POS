#!/usr/bin/env node
/**
 * Batch fix: Add type="button" to buttons without type
 */
...
files.forEach(file => {
    ...
    // Fix buttons without type that have onClick
    // Pattern: <button followed by onClick without type=
    content = content.replace(
        /<button(?![^>]*type=)([^>]*onClick=[^>]*)>/g,
