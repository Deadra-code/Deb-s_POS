        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Tambah Pesanan Manual">
            <div className="space-y-6 text-slate-800 dark:text-slate-100">
                <div className="space-y-2">
                    ...
                    <input
                        type="text"
                        className="w-full p-4 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl outline-none focus:ring-2 focus:ring-emerald-500 font-bold text-slate-800 dark:text-slate-100 shadow-inner"
                ...
                <div className="space-y-2">
                    ...
                    <input
                        type="number"
                        className="w-full p-4 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl outline-none focus:ring-2 focus:ring-emerald-500 font-black text-2xl text-emerald-600 dark:text-emerald-400 shadow-inner"
                        placeholder="0"
