            ...
            <div className="p-4 flex-1 space-y-3">
                {order.items.map((i, idx) => (
                    <div key={idx} className="flex gap-3 text-sm items-start">
                        <span className="bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 w-7 h-7 flex items-center justify-center rounded-lg font-bold shrink-0">{i.qty}</span>
