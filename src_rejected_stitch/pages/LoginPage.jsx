            ...
            <div className="hidden lg:flex lg:w-1/2 bg-emerald-600 dark:bg-emerald-500 relative overflow-hidden items-center justify-center p-12">
                <div className="z-10 text-white max-w-md">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        <div className="w-16 h-16 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center mb-8 shadow-2xl overflow-hidden">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 md:p-20">
                ...
                >
                    <div className="lg:hidden flex items-center gap-3 mb-10">
                        <div className="w-10 h-10 bg-emerald-600 rounded-xl flex items-center justify-center text-white shadow-lg shadow-emerald-500/20 overflow-hidden">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        {error && (
                            <div className="bg-red-50 dark:bg-red-950/30 text-red-600 dark:text-red-400 p-4 rounded-2xl text-sm text-center font-bold border border-red-100 dark:border-red-900/50 overflow-hidden">
                                {error}
                            </div>
                        )}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    type="password"
                                    required
                                    className="w-full bg-white dark:bg-slate-900 border-2 border-slate-100 dark:border-slate-800 p-4 pl-12 rounded-2xl outline-none focus:border-emerald-500/50 focus:ring-4 focus:ring-emerald-500/5 transition-all text-slate-800 dark:text-white font-bold overflow-hidden"
                                    placeholder="••••••"
                                    value={pass}
